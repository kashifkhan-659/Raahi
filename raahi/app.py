...
def show_results():
    ...
    if not top_3:
        ...
        st.caption("Generated by AI based on your unique profile")

        try:
            client = OpenAI(api_key=st.secrets["OPENAI_API_KEY"])

            with st.spinner("Generating your personal guidance..."):
                response = client.chat.completions.create(
                    model="gpt-4o-mini",
                    messages=[
                        {
                            "role": "system",
                            "content": "You are an honest and practical university career counselor for Pakistani students.",
                        },
                        {
                            "role": "user",
                            "content": f"""
                       ...
                       Write a short, honest, encouraging 3-4 sentence career 
                       guidance message for this student.
                       - Mention their strongest trait
                       - Reference their top recommended program
                       - Give one practical piece of advice for success
                       - Be direct and realistic, not generic
                       - Talk directly to the student
                       - No bullet points, just natural paragraph text
                       - Under 100 words
                       """,
                        },
                    ],
